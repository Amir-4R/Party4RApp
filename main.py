...
Required environment variables (set in Render dashboard â†’ Environment):
  MONGO_URI            MongoDB Atlas connection string
  DB_NAME              Logical DB name (default: party4r)
  JWT_SECRET           64-char random hex
  YOUTUBE_API_KEY      Google YouTube Data API v3 key
  CORS_ORIGINS         "*" or comma-separated list
  TOKEN_EXPIRE_HOURS   Default 168 (1 week)
...
if not os.environ.get("JWT_SECRET"):
    logger.warning("JWT_SECRET not set â€” generated ephemeral key. Tokens invalidate on restart.")
if MONGO_URI.startswith("mongodb://localhost"):
    logger.warning("MONGO_URI points to localhost â€” set a real MongoDB Atlas URI in production.")
