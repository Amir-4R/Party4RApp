...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    play_carrom: "Carrom",
    play_damma: "Damma",
    // Damma (Dominoes) game strings
    your_turn: "Your Turn",
    opponent_turn: "Opponent's Turn",
    boneyard: "Boneyard",
    place_first_tile: "Place the first tile",
    tap_to_draw: "Tap to draw",
    thinking: "Thinking...",
    ends: "Ends",
    left: "Left",
    right: "Right",
    ...
    max_rank: "Top rank",
    rank_up: "Rank up!",
    loss_encourage: "Better luck next time — you're improving!",
    your_rank: "Your rank",
    games_label: "Games",
    no_games_yet: "No matches yet — start from the Play tab!",
    matches: "matches",
    wins_short: "W",
    losses_short: "L",
    winrate_short: "win",
    peak_rank: "Peak rank",
    online_soon_title: "Online play coming soon",
    online_soon_body: "Random online matchmaking is being activated. You can practice vs the computer now.",
    friends_soon_title: "Friend matches coming soon",
    friends_soon_body: "Friend invites are being activated. You can practice vs the computer now.",
    bot: "Bot",
    // ── Comms (in-game chat / friends / mic) ─────────────────────────
    game_chat: "Chat",
    type_message: "Type a message…",
    no_messages_yet: "No messages yet — start chatting",
    friends: "Friends",
    no_friends_online: "No friends available right now",
    hold_to_talk: "Hold to talk",
    talking: "Talking…",
    mic_muted: "Muted",
    mic_privacy: "Who can hear me?",
    mic_off: "Off",
    mic_opponent: "Opponent only",
    mic_friends: "Friends only",
    mic_everyone: "Everyone",
    mic_perm_title: "Microphone permission",
    mic_perm_body: "Enable the microphone permission in your device settings to use voice chat.",
  ...
  ar: {
    ...
    play_carrom: "كيرم",
    play_damma: "ضمنة",
    // Damma (Dominoes) game strings — Arabic
    your_turn: "دورك",
    opponent_turn: "دور الخصم",
    boneyard: "السحب",
    place_first_tile: "ضع أول حجر",
    tap_to_draw: "اضغط للسحب",
    thinking: "يفكر...",
    ends: "الأطراف",
    left: "يسار",
    right: "يمين",
    pass: "تخطي",
    pass_turn: "تخطي الدور",
    draw_tile: "اسحب",
    bot_easy: "سهل",
    bot_medium: "متوسط",
    bot_hard: "صعب",
    choose_difficulty: "اختر المستوى",
    mode_1v1: "ثنائي (٢ لاعبين)",
    mode_4p: "رباعي (٤ لاعبين)",
    ...
    max_rank: "أعلى رتبة",
    rank_up: "ترقية رتبة!",
    loss_encourage: "حظ أوفر في المرة القادمة — أنت تتحسّن!",
    your_rank: "رتبتك",
    games_label: "الألعاب",
    no_games_yet: "لم تلعب أي مباراة بعد — ابدأ من قسم العب!",
    matches: "مباراة",
    wins_short: "ف",
    losses_short: "خ",
    winrate_short: "فوز",
    peak_rank: "أعلى رتبة",
    online_soon_title: "اللعب الأونلاين قريباً",
    online_soon_body: "نظام المباريات العشوائية أونلاين قيد التفعيل. يمكنك الآن التدرّب ضد الكمبيوتر.",
    friends_soon_title: "اللعب مع الأصدقاء قريباً",
    friends_soon_body: "دعوات اللعب مع الأصدقاء قيد التفعيل. يمكنك الآن التدرّب ضد الكمبيوتر.",
    bot: "روبوت",
    // ── Comms (دردشة + أصدقاء + مايك داخل اللعبة) ──────────────────
    game_chat: "الدردشة",
    type_message: "اكتب رسالة…",
    no_messages_yet: "لا رسائل بعد — ابدأ المحادثة",
    friends: "الأصدقاء",
    no_friends_online: "لا أصدقاء متاحون الآن",
    hold_to_talk: "اضغط مطوّلاً",
    talking: "يتحدّث…",
    mic_muted: "مكتوم",
    mic_privacy: "من يسمع صوتي؟",
    mic_off: "مطفي",
    mic_opponent: "الخصم فقط",
    mic_friends: "الأصدقاء فقط",
    mic_everyone: "الجميع",
    mic_perm_title: "صلاحية المايك",
    mic_perm_body: "فعّل صلاحية الميكروفون من إعدادات الجهاز لاستخدام التحدّث الصوتي.",
