// =============================================================================
// app/game/matchmaking.tsx — Online random matchmaking (graceful gate)
// =============================================================================
// Online multiplayer activates once the game backend is deployed
// (isBackendReady in app/(tabs)/play.tsx). Until then this screen explains the
// status and offers a one-tap fallback to play vs the bot, so the "random
// online" flow never dead-ends.
// =============================================================================
  ...
  return (
    <View style={[styles.root, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>{t("play_global") || "لعب عشوائي أونلاين"}</Text>
        <View style={{ width: 40 }} />
      </View>

      <View style={styles.body}>
        <View style={[styles.iconWrap, { borderColor: FUTURISTIC.brand, backgroundColor: withAlpha(FUTURISTIC.brand, 0.12) }]}>
          <Ionicons name="globe-outline" size={48} color={FUTURISTIC.brand} />
        </View>
        <Text style={styles.heading}>{t("online_soon_title") || "اللعب الأونلاين قريباً"}</Text>
        <Text style={styles.sub}>
          {t("online_soon_body") ||
            "نظام المباريات العشوائية أونلاين قيد التفعيل. يمكنك الآن التدرّب ضد الكمبيوتر بنفس اللعبة."}
        </Text>
